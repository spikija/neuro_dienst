...
const _en = <String, String>{
  ...
  'refreshingCalendar': 'Refreshing calendar...',
  'calendarRefreshed': 'Calendar refreshed.',
  'couldNotRefreshCalendar': 'The calendar could not be refreshed.',
  ...
  'reportDate': 'Date',
  'reportDay': 'Day',
  'reportAbsenceShort': 'Abs',
  'reportVacationShort': 'VAC',
  'reportNotes': 'Notes',
  'holiday': 'Holiday',
  'weekend': 'Weekend',
  'reportRoleLegend':
      'Roles: SUL Stroke Unit Leader, SU1/SU2 Stroke Unit Team, AMB Outpatient Clinic, SON Neurosonology, NVB Neurovascular Board, OFO OFO Board',
  'reportDoctorLegend': 'Doctors: {doctors}',
  'reportRole.SUL': 'Stroke Unit Leader',
  'reportRole.SU1': 'Stroke Unit Team 1',
  'reportRole.SU2': 'Stroke Unit Team 2',
  'reportRole.AMB': 'Outpatient Clinic',
  'reportRole.ICB': 'Outpatient Clinic',
  'reportRole.SON': 'Neurosonology',
  'reportRole.NVB': 'Neurovascular Board',
  'reportRole.OFO': 'OFO Board',
  'reportRole.SCI': 'Science',
  'roles': 'Roles',
...
const _de = <String, String>{
  ...
  'refreshingCalendar': 'Kalender wird aktualisiert...',
  'calendarRefreshed': 'Kalender wurde aktualisiert.',
  'couldNotRefreshCalendar': 'Der Kalender konnte nicht aktualisiert werden.',
  'loadingMonth': 'Monat wird geladen...',
  'weekday.mon': 'Mo',
  'weekday.tue': 'Di',
  'weekday.wed': 'Mi',
  'weekday.thu': 'Do',
  ...
  'reportGenerated': 'Erstellt: {date}',
  'reportDate': 'Datum',
  'reportDay': 'Tag',
  'reportAbsenceShort': 'Abw.',
  'reportVacationShort': 'URL',
  'reportNotes': 'Notizen',
  'holiday': 'Feiertag',
  'weekend': 'Wochenende',
  'reportRoleLegend':
      'Rollen: SUL Stroke Unit Leader, SU1/SU2 Stroke Unit Team, AMB Ambulanz, SON Neurosonologie, NVB Neurovaskulaeres Board, OFO OFO-Board',
  'reportDoctorLegend': 'Aerzte: {doctors}',
  'reportRole.SUL': 'Stroke Unit Leitung',
  'reportRole.SU1': 'Stroke Unit Team 1',
  'reportRole.SU2': 'Stroke Unit Team 2',
  'reportRole.AMB': 'Ambulanz',
  'reportRole.ICB': 'Ambulanz',
  'reportRole.SON': 'Neurosonologie',
  'reportRole.NVB': 'Neurovaskulaeres Board',
  'reportRole.OFO': 'OFO-Board',
  'reportRole.SCI': 'Wissenschaft',
  'roles': 'Rollen',
  'physicians': 'Aerzte',
